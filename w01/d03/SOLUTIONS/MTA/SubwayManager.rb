...
class SubwayManager
  ...
  def menu
    ...
    total_length_of_trip = calculate_distance(start_train, stop_a, stop_train, stop_b)
    puts "\n\nYour trip length is #{total_length_of_trip} stops.\n\n".color('#ff9900')

  end


  def calculate_distance(start_train, stop_a, stop_train, stop_b)
