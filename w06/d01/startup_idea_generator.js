...
function randomThis(){
  var randThis = thisArray[Math.floor(Math.random() * thisArray.length)];
  return randThis
}

function randomThat(){
  var randThat = thatArray[Math.floor(Math.random() * thatArray.length)];
  return randThat
}
...
console.log(whatDoesYourStartupDo())
